...
class AccidentRegisterModel {
  ...
  /* static AccidentRegisterModel getData() {

    return AccidentRegisterModel([CheckBoxListModel('1.Speed Restriction info',false),
                               CheckBoxListModel('2.Message  Display  on Notice Board',false)
                              ],

     static void postData(AccidentRegisterModel dt) {
     print('Helo2');

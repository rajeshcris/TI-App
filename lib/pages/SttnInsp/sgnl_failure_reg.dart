...
class _SgnlFailureState extends State<SgnlFailure> {
  ...
  SgnlFailureModel SgnlFailureMod = new SgnlFailureModel([
    'Monthly Summary of Failures by SS',
    'Relay Room Key check',
    'Double Lock of Relay Room',
    'Relay  Room History',
    'Reason to Open Relay Room by S&T'
  ], [
    '',
    '',
    '',
  ...
  callbackCamera(imageF) {
    setState(() {
      SgnimageFile = imageF;
      print('callback:' + SgnimageFile.path.toString());
    });
  }
  ...
  Widget FormUI(BuildContext context) {
    return Column(
      children: [
        ...
        Center(
          child: CameraCls(
              cameraCallBack: callbackCamera, imageFile: SgnimageFile),
        ),
        ...
        Container(
          child: ButtonTheme(
            ...
            child: MaterialButton(
              onPressed: () async {
                _callSaveCautionOrdRegWebService(SgnlFailureMod).then((res) {

...
class _CautionOrdRegState extends State<CautionOrdReg> {
  ...
  CautionOrdRegModel cautionOrdMod = new CautionOrdRegModel(
      ['Speed Restriction info', 'Message  Display  on Notice Board'],['',''],
      ['', ''],
      '');
  ...
  callbackDropDown(callBackController , selected , show ){
    setState(() {
      ...
      print('callBackController:' + cautionOrdMod.ynList1[0]+ cautionOrdMod.ynList1[1] + whyNocontroller[0].text + whyNocontroller[1].text) ;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: new Scaffold(
        key: _scaffoldkey,
        appBar: TiUtilities.tiAppBar(context, "Caution Order Register"),
        body: Builder(
  ...
  Widget FormUI(BuildContext context) {
    return Column(
      children: [
        ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: Card(
                child: dropdowncls(dropdowntextcallback: callbackDropDown,slst: cautionOrdMod.sList1,ynlst: cautionOrdMod.ynList1,index: index,selectedItem: selectedItemValue, showTextField: showText,whyNoCont: whyNocontroller),
        ...
        Center(
          child: CameraCls(cameraCallBack: callbackCamera,imageFile: CauimageFile),

...
import 'package:ti/model/SttnInspModels/point_crossing_joint_inspection.dart';
...
class _PointCrossingJointInspectRegisterState
  ...
  List<bool> showText = [false, false, false, false, false, false];
  ...
  PointCrossingJointInspectRegisterModel stationDarymod =
      new PointCrossingJointInspectRegisterModel([
        ...
        Container(
          child: ButtonTheme(
            ...
            child: MaterialButton(
              onPressed: () async {
                _callSavePointCrossingJointInspectRegisterWebService(
                        stationDarymod)
                    .then((res) {

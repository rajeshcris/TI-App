...
class _PowerTrafficBlockRegisterState extends State<PowerTrafficBlockRegister> {
  ...
  PowerTrafficBlockRegisterModel accidentregMod =
      new PowerTrafficBlockRegisterModel(
          ['Proper Maintenance of traffic block register'], [''], [''], '');
        ...
        Container(
          child: ButtonTheme(
            ...
            child: MaterialButton(
              onPressed: () async {
                _callSavePowerTrafficBlockRegisterWebService(accidentregMod)
                    .then((res) {

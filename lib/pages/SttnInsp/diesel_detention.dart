...
import 'package:ti/model/SttnInspModels/disel_detention_register.dart';
import 'dart:convert';
...
class _DieselDetentionState extends State<DieselDetention> {
  ...
  DieselDetentionModel dsldetnModel = new DieselDetentionModel([
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < showText.length; i++)
      whyNocontroller.add(TextEditingController());
        ...
        Container(
          child: ButtonTheme(
            ...
            child: MaterialButton(
              onPressed: () async {
                _callSaveDieselDetentionWebService(dsldetnModel).then((res) {

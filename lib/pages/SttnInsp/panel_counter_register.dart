...
class _PanelCounterRegisterState extends State<PanelCounterRegister> {
  ...
  PanelCounterRegisterModel accidentregMod = new PanelCounterRegisterModel(
      ['Matching of counter reading with counter register '], [''], [''], '');
        ...
        Container(
          child: ButtonTheme(
            ...
            child: MaterialButton(
              onPressed: () async {
                _callSavePanelCounterRegisterWebService(accidentregMod)
                    .then((res) {

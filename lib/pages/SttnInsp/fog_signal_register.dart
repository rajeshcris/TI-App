...
import 'package:ti/model/SttnInspModels/fog_signal_register.dart';
import 'dart:convert';
...
class _FogSignalRegisterState extends State<FogSignalRegister> {
  ...
  FogSignalRegisterModel accidentregMod = new FogSignalRegisterModel([
        ...
        Container(
          child: ButtonTheme(
            ...
            child: MaterialButton(
              onPressed: () async {
                _callSaveFogSignalRegisterWebService(accidentregMod)
                    .then((res) {

...
class _CrankHndlRegState extends State<CrankHndlReg> {
  ...
  CrankHndlRegModel crankHndlMod = new CrankHndlRegModel(
      ['Locking of Motor Point and Key with SM', 'Locking of Crank Handle if Not in Use' , 'Crank Handle Entry with SM and ESM signature'],
      ['','',''],
      ['', '',''],
      '');
  ...
  callbackCamera(imageF){
    setState(() {
      CraimageFile = imageF ;
      print('callback:' + CraimageFile.path.toString()) ;
    });
  }
  ...
  Widget FormUI(BuildContext context) {
    return Column(
      children: [
        ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: Card(
                child: dropdowncls(dropdowntextcallback: callbackDropDown,slst: crankHndlMod.sList1,ynlst: crankHndlMod.ynList1,index: index,selectedItem: selectedItemValue, showTextField: showText,whyNoCont: whyNocontroller),
        ...
        Center(
          child: CameraCls(cameraCallBack: callbackCamera,imageFile: CraimageFile),
        ...
        Container(
          child: ButtonTheme(
            ...
            child: MaterialButton(
              onPressed: () async {
                _callSaveCautionOrdRegWebService(crankHndlMod)
                    .then((res) {
